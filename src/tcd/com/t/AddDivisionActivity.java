...
//resultSetOutput.setText(OutputData);
				...
				Toast.makeText( getApplicationContext(), "Submited Division Detail Successfully ",Toast.LENGTH_LONG).show();
...
buttonDReset.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				EditText txtDName=(EditText) findViewById(R.id.editTextDivName);
...
buttonDCancel.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View arg0) {
		// TODO Auto-generated method stub
		Intent intentd=new Intent(AddDivisionActivity.this,AfterAdminMainActivity.class);
